...
function crearHojaPadrinos() {
  ...
  const base = "https://images.squarespace-cdn.com/content/v1/531d3bd6e4b0ddc80ccfca51";
  sheet.getRange(1, 1, 5, 9).setValues([
    ...
    ["a1", "Coco", "", "", base + "/1615001755380-YQE0K8HOXEBNIM1J4AR3/img-08.jpg", "10,25,50", "whatsapp", "", "SI"],
    ["a2", "Luna", "", "", base + "/1615142307702-APJ87BNVD9E5FO9LO7R5/img-01.jpg", "10,25,50", "whatsapp", "", "SI"],
    ["a3", "Kiara", "", "", base + "/1598633978077-NZ9LUXBENH7F8W8AS3YP/img-03.jpg", "10,25,50", "whatsapp", "", "SI"],
    ["", "", "", "", "", "", "", "", ""]
  ]);
  sheet.setFrozenRows(1);
  ...
  sheet.getRange("A7").setValue(
    "Notas: a1, a2 y a3 usan las descripciones traducidas de la página (dejá Especie e Historia vacías). " +
    "Para un animal nuevo usá otro ID (ej: a4) y llenó Especie e Historia (se mostrarán igual en todos los idiomas). " +
